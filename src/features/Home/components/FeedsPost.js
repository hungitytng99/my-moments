...
import CONTROL_LIST from "../constants/ControlList";
...
function FeedsPost(props) {
    const { user, linkToUserPage, avatar, location, img_list, liked, status, comment, dateCreated, isLikedProps, isFavouriteProps } = props.post;
    ...
    return (
        <div className="feeds-post">
            <ControlModal modalIsOpen={isOpenControl} openModal={openControlModal} closeModal={closeControlModal} itemsList={CONTROL_LIST} />
            <div className="post__user">
                <Link to={linkToUserPage}>
                    <img className="post__user-avatar" src={avatar} alt="avatar-user"></img>
                </Link>
            ...
            <div className="feeds-post__text">
                <div className="post-interactive">
                    <div className="post-interactive__group">
                        {isLiked ? <i className="post-interactive__icon --loved fas fa-heart" onClick={handleLikedClick}></i> : <i className="post-interactive__icon --love far fa-heart" onClick={handleLikedClick}></i>}
                    ...
                    <div className="post-interactive__group">
                        {!isFavourite ?
                            <i className="post-interactive__icon --bookmark far fa-bookmark" onClick={handleFavouriteClick}></i> :
                            <i className="post-interactive__icon --bookmarked fas fa-bookmark" onClick={handleFavouriteClick}></i>}
                    </div>
                </div>
                ...
                <div className="post-status">
                    <Link to={linkToUserPage} className="post-status__username">{user}</Link>
