...
function Header() {
    ...
    const handleClickNav = (redirectTo) => {
        console.log(navSelection);
        setIsSelectItem(navSelection);
        if (redirectTo) {
                    ...
                    <ul className="header-control__list">
                        <li className="header-control__item">
                            <div className="custom-icon-home">
                                {isSelectItem === 1 ?
                                    <ion-icon name="home" onClick={() => handleClickNav(HeaderNav.navLink.HOME)}></ion-icon>
                                    : <ion-icon name="home-outline" onClick={() => handleClickNav(HeaderNav.navLink.HOME)}></ion-icon>}
                            </div>
                        </li>
                        <li className="header-control__item">
                            {isSelectItem === 2 ?
                                <i className="fas fa-comment-dots"></i>
                                : <i className="far fa-comment-dots" onClick={() => handleClickNav(HeaderNav.navLink.INBOX)}></i>}
                        </li>
                        <li className="header-control__item">
                            {isSelectItem === 3 ?
                                <i className="fas fa-compass"></i>
                                : <i className="far fa-compass" onClick={() => handleClickNav(HeaderNav.navLink.EXPLORE)}></i>}

                        </li>
                        <li className="header-control__item">
                            {isSelectItem === 4 ?
                                <i className="fas fa-bell"></i>
                                : <i className="far fa-bell" onClick={() => handleClickNav(HeaderNav.navLink.STORE)}></i>}
                        </li>
                        <li className="header-control__item">
                            <div className="header__dropdown">
                                {(isShowDropDown) ?
                                    <div tabIndex="5" className="no-focus-outline" onBlur={(e) => handleClickDropDown()}>
                                        <div className="fas fa-user-circle" onClick={(e) => handleClickDropDown()}></div>
                                        ...
                                        <div className="header__dropdown-box noselect" onMouseDown={(e) => handleDropdownDisplay(e)}>
                                            <ul className="header__dropdown-list" >
                                                <li className="header__dropdown-item" onClick={() => handleClickNav(username)}>
                                    ...
                                    :
                                    <>
                                        <div tabIndex="5" className="no-focus-outline far fa-user-circle" onClick={(e) => handleClickDropDown()}></div>
                                    </>
                                }
